...
abstract class BaseService {
  ...
  /// The client base type used for proxy lookup.
  ///
  /// Worker subclasses override this to return the base service interface
  /// type so that host-side proxy registration is transparent.
  Type get clientBaseType => runtimeType;
  ...
  ///
  /// Worker classes generated by codegen override this.
  /// Default implementation does nothing for local services.
